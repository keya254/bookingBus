...
class StatusTripTest extends TestCase
{
    ...
    public function test_user_has_permission_status_trip_can_change_status_belong_to_this_user()
    {
    ...
    public function test_user_has_permission_status_trip_can_change_status_not_belong_to_this_user()
    {
        $trip = Trip::factory()->create();
