...
class EditTripTest extends TestCase
{
    ...
    public function test_user_have_permission_edit_trip_and_day_equal_before_today()
    {
        //give permission to user edit-trip
        $this->user->givePermissionTo('edit-trip');
        //login user visit page
    ...
    public function test_user_have_permission_edit_trip_and_day_not_date()
    {
        //give permission to user edit-trip
        $this->user->givePermissionTo('edit-trip');
        //login user visit page
    ...
    public function test_user_have_permission_edit_trip_and_start_time_not_time()
    {
        //give permission to user edit-trip
        $this->user->givePermissionTo('edit-trip');
        //login user visit page
