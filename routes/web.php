...
Route::group(['prefix' => 'backend', 'namespace' => 'Backend', 'middleware' => 'auth'], function () {
    //Car
    Route::post('/car/changestatus', 'ChangeCarController@changeStatus')->name('car.changestatus');
    Route::post('/car/changepublic', 'ChangeCarController@changePublic')->name('car.changepublic');
    Route::post('/car/changeprivate', 'ChangeCarController@changePrivate')->name('car.changeprivate');
